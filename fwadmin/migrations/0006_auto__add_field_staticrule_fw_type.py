...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaticRule.fw_type'
        db.add_column(u'fwadmin_staticrule', 'fw_type',
                      self.gf('django.db.models.fields.CharField')(default='cisco', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StaticRule.fw_type'
        db.delete_column(u'fwadmin_staticrule', 'fw_type')
