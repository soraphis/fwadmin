...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SamplePort'
        db.create_table(u'fwadmin_sampleport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
            ('ip_protocol', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal(u'fwadmin', ['SamplePort'])

        # Adding model 'ComplexRule'
        db.create_table(u'fwadmin_complexrule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fwadmin.Host'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('from_net', self.gf('django.db.models.fields.CharField')(default='any', max_length=100)),
            ('permit', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('ip_protocol', self.gf('django.db.models.fields.CharField')(default='TCP', max_length=10)),
            ('port', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'fwadmin', ['ComplexRule'])

        # Adding model 'Host'
        db.create_table(u'fwadmin_host', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('ip', self.gf('django.db.models.fields.GenericIPAddressField')(unique=True, max_length=39)),
            ('active_until', self.gf('django.db.models.fields.DateField')()),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'fwadmin', ['Host'])


    def backwards(self, orm):
        # Deleting model 'SamplePort'
        db.delete_table(u'fwadmin_sampleport')

        # Deleting model 'ComplexRule'
        db.delete_table(u'fwadmin_complexrule')

        # Deleting model 'Host'
        db.delete_table(u'fwadmin_host')
