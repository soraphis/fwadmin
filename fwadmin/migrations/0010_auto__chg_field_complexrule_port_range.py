...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComplexRule.port_range'
        db.alter_column(u'fwadmin_complexrule', 'port_range', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'ComplexRule.port_range'
        db.alter_column(u'fwadmin_complexrule', 'port_range', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        ...
        u'fwadmin.complexrule': {
            ...
            'port_range': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'})
        },
        u'fwadmin.host': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 25, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'fwadmin.staticrule': {
            ...
            'fw_type': ('django.db.models.fields.CharField', [], {'default': "'cisco'", 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
