...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExportRulesToken'
        db.create_table(u'fwadmin_exportrulestoken', (
        ...
        db.send_create_signal(u'fwadmin', ['ExportRulesToken'])


    def backwards(self, orm):
        # Deleting model 'ExportRulesToken'
        db.delete_table(u'fwadmin_exportrulestoken')
    ...
    models = {
        ...
        u'fwadmin.exportrulestoken': {
            'Meta': {'object_name': 'ExportRulesToken'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
