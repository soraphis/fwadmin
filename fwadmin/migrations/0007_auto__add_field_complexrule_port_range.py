...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComplexRule.port_range'
        db.add_column(u'fwadmin_complexrule', 'port_range',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComplexRule.port_range'
        db.delete_column(u'fwadmin_complexrule', 'port_range')
    ...
    models = {
        ...
        u'fwadmin.complexrule': {
            ...
            'port_range': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
        u'fwadmin.host': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 24, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
